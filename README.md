...
Non-custodial recurring payments on Stellar. Charge authorization lives in the Payer's own Smart Wallet (via a Policy Signer with a fixed amount, recipient, and cadence), not in an open-ended allowance held by the Payee.
